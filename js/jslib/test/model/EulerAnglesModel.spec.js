...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PreFormApi.EulerAnglesModel();
  });
  ...
  describe('EulerAnglesModel', function() {
    it('should create an instance of EulerAnglesModel', function() {
      // uncomment below and update the code to test EulerAnglesModel
      //var instance = new PreFormApi.EulerAnglesModel();
      //expect(instance).to.be.a(PreFormApi.EulerAnglesModel);
    });
