...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PreFormApi.Form3Printer();
  });
  ...
  describe('Form3Printer', function() {
    it('should create an instance of Form3Printer', function() {
      // uncomment below and update the code to test Form3Printer
      //var instance = new PreFormApi.Form3Printer();
      //expect(instance).to.be.a(PreFormApi.Form3Printer);
    });
