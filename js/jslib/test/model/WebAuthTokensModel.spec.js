...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PreFormApi.WebAuthTokensModel();
  });
  ...
  describe('WebAuthTokensModel', function() {
    it('should create an instance of WebAuthTokensModel', function() {
      // uncomment below and update the code to test WebAuthTokensModel
      //var instance = new PreFormApi.WebAuthTokensModel();
      //expect(instance).to.be.a(PreFormApi.WebAuthTokensModel);
    });
