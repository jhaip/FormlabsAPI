...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PreFormApi.ScenePositionModel();
  });
  ...
  describe('ScenePositionModel', function() {
    it('should create an instance of ScenePositionModel', function() {
      // uncomment below and update the code to test ScenePositionModel
      //var instance = new PreFormApi.ScenePositionModel();
      //expect(instance).to.be.a(PreFormApi.ScenePositionModel);
    });
