...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PreFormApi.GenericDevice();
  });
  ...
  describe('GenericDevice', function() {
    it('should create an instance of GenericDevice', function() {
      // uncomment below and update the code to test GenericDevice
      //var instance = new PreFormApi.GenericDevice();
      //expect(instance).to.be.a(PreFormApi.GenericDevice);
    });
