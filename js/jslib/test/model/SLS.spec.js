...
(function(root, factory) {
  ...
  describe('SLS', function() {
    it('should create an instance of SLS', function() {
      // uncomment below and update the code to test SLS
      //var instance = new PreFormApi.SLS();
      //expect(instance).to.be.a(PreFormApi.SLS);
    });
