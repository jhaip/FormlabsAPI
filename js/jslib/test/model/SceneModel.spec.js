...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new PreFormApi.SceneModel();
  });
  ...
  describe('SceneModel', function() {
    it('should create an instance of SceneModel', function() {
      // uncomment below and update the code to test SceneModel
      //var instance = new PreFormApi.SceneModel();
      //expect(instance).to.be.a(PreFormApi.SceneModel);
    });
    ...
    it('should have the property sceneType (base name: "scene_type")', function() {
